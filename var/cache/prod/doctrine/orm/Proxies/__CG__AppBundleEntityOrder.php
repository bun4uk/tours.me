...
class Order extends \AppBundle\Entity\Order implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Order' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Order' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Order' . "\0" . 'email', '' . "\0" . 'AppBundle\\Entity\\Order' . "\0" . 'type', '' . "\0" . 'AppBundle\\Entity\\Order' . "\0" . 'count', '' . "\0" . 'AppBundle\\Entity\\Order' . "\0" . 'createdAt'];
        }
